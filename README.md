...
Shortcode is tested against ruby version 1.9.3 and greater as well as jruby, it will not work with ruby 1.8. Shortcode rails integration is tested against
